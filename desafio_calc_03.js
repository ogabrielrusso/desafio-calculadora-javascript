...
let jogadores = [
    { vitorias: 6, derrotas: 1 },
    { vitorias: 20, derrotas: 8 },
    { vitorias: 100, derrotas: 0 }
];

for (let i = 0; i < jogadores.length; i++) {
    let resultadoJogador = calculateRankedLevel(jogadores[i].vitorias, jogadores[i].derrotas);
    console.log("Jogador " + (i + 1) + ": Saldo " + resultadoJogador.saldo + ", Nível " + resultadoJogador.nivel);
}